...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 23 14:24:03 2024
...
for v_i, v_value  in enumerate(v): # parameter loop
    # for rc_i, rc_value in enumerate(rc): # parameter loop 
        ...
        data_new = data/data_ref
        for i in range (0, 1000):
            data_new[i,i] = 50
        heatmap = ax.imshow(data_ref, cmap=color_map, interpolation='nearest',norm=LogNorm(vmin=0.001, vmax=1))
